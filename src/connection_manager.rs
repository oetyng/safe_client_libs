...
use sn_messaging::{
    ...
    network_info::{
        Error as InfrastructureUpdate, GetSectionResponse, Message as NetworkInfoMsg, NetworkInfo,
    },
...
impl ConnectionManager {
    ...
    async fn update_infrastructure_information(&self, info: NetworkInfo) -> Result<(), Error> {
